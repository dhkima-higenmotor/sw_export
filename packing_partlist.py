...
class FilePackerApp:
    def __init__(self, master):
        self.master = master
        master.title("Copy drowing files by csv partlist")
        ...
        self.packing_button.grid(row=1, column=0, padx=10, pady=10)
    ...
    def copy_files(self):
        ...
        for file_path in self.pdf_path + self.dxf_path + self.step_path:
            try:
